...
''
  ...
  volumes:
    data: # Volume for Windows VM data.
      driver: local
  ...
  services:
    windows:
      ...
      environment:
        ...
        # httpsusername://github.com/dockur/windows?tab=readme-ov-file#how-do-i-select-the-windows-version
      ...
      ports:
        ...
        - 127.0.0.1:3389:3389/tcp # Map '3389' on Linux host to '3389' on Windows VM --> For Remote Desktop Protocol (RDP).
        - 127.0.0.1:3389:3389/udp # Map '3389' on Linux host to '3389' on Windows VM --> For Remote Desktop Protocol (RDP).
      ...
      volumes:
        ...
        - ~/oem:/oem # Only necessary at first startup. You should get it from the repo (https://github.com/winapps-org/winapps). Enables automatic post-install execution of 'oem/install.bat', applying Windows registry modifications contained within 'oem/RDPApps.reg'.
      ...
      devices:
        ...
        #- /dev/sdY:/disk2 # Uncomment to mount a disk directly within the Windows VM (Note: 'disk2' and higher will be mounted as secondary drives).d
''